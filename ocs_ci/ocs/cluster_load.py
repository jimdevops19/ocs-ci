...
class ClusterLoad:
    ...
    def reach_cluster_load_percentage_in_throughput(
        ...
        """
        This function determines how many pods, that are running FIO, needed in order to
        reach the requested cluster load percentage.
        ...
        pod_obj.run_io(
            ...
            runtime=io_run_time, rate='200M', bs='128K', rw_ratio=25
        )
